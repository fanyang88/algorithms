...
var shortestDistance = function(maze, start, destination) {
    var st = [],  visited = {}, m=maze.length, n = maze[0].length, dir = [[0, 1], [0, -1], [-1, 0], [1, 0]];
    ...
    return visited[destination[0]+':'+destination[1]]=== undefined ? -1 : visited[destination[0]+':'+ destination[1]];
};
