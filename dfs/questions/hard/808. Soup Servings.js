...
var soupServings = function(N) {
    if(N > 5000)  return 1;
    var map = {}, portion= [[100, 0], [75, 25], [50, 50], [25, 75]];
    return dfs(N, N, map, portion);
};

var dfs = function(A, B, map, portion) {
    ...
    var probility = 0.0;
    for(var i=0; i<4; i++) {
        probility += dfs(A-portion[i][0], B-portion[i][1], map, portion);
    }
    map[A+':'+B] = probility * 0.25;
    return map[A+':'+B];
}