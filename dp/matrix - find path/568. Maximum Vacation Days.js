/*
LeetCode wants to give one of its best employees 
the option to travel among N cities to collect algorithm problems. 
...
You can only take flights at most once per day and can only take flights 
on each week's Monday morning. Since flight time is so short, 
...
var maxVacationDays = function(flights, days) {
    var n = days.length, k= days[0].length, dp = new Array(n), maxV = 0;
    for(var i=0; i<n; i++) {
